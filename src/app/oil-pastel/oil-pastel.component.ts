...
@Component({
  selector: 'app-oil-pastel',
  templateUrl: './oil-pastel.component.html',
  styleUrls: ['./oil-pastel.component.scss']
})
export class OilPastelComponent implements OnInit{
  data!: any;
  filterData!: any;
  inputData!: string;
  page: number = 1;
